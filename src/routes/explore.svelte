...
<body style="margin-top: 0;background: linear-gradient(black 0%, rgb(239,229,229) 50%, rgb(216,41,41));">
    <div class="title-div" style="margin-top: 50px;margin-bottom: 50px;">
        <h1>EXPLORE</h1>
    </div>
    <div style="background: rgba(237,42,42,0);">
        <div class="row" >
